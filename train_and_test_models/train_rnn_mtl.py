...
import sys
import numpy as np
import torch_asa.data_prep.prof_prep as pp
import torch

from torch_asa.models.parameters.rnn_params import params
from torch_asa.models.input_models import *
from torch_asa.models.train_and_test_models import *
...
if __name__ == "__main__":
    ...
    for lr in params.lrs:
        for wd in params.weight_decay:
            ...
            loss_func = MTLLossWrapper(3, model)
