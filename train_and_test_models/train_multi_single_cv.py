    ...
    for rating in ratings:
        for lr in lrs:
            ...
            for i in range(0, 5):
                ...
                model = MultiInput_single_cv(device=device, feats=feats, params=params)
                test_model = MultiInput_single_cv(device=device, feats=feats, params=params)
                ...
                if not os.path.exists(model_save_file):
                    train_and_predict_embrace_single_cv(
                        classifier=model,
